...
export interface ERC721SimpleInterface extends utils.Interface {
  functions: {
    ...
    "toggleSaleState()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "toggleSaleState",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ERC721Simple extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721SimpleInterface;
  ...
  callStatic: {
    ...
    toggleSaleState(overrides?: CallOverrides): Promise<void>;
